...
export default function HospitalDashboardScreen() {
  ...
  const [hospitalProfile, setHospitalProfile] = useState<HospitalUser | null>(null);
  ...
  const fetchHospitalData = useCallback(async () => {
    ...
    try {
      ...
      const acceptedDonors = requests.reduce((sum, r) => sum + (r.acceptedDonors?.length || 0), 0);
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <View>
              ...
              <Text style={styles.hospitalName}>{hospitalProfile?.hospitalName}</Text>
            </View>
          </View>
          <TouchableOpacity onPress={handleLogout} style={styles.logoutButton}>
            <Ionicons name="log-out-outline" size={24} color={palette.primaryRed} />
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.statsContainer}>
          <View style={styles.statsGrid}>
            ...
            <View style={styles.statCard}>
              <View style={[styles.statIconContainer, { backgroundColor: '#E91E6315' }]}>
        ...
        <View style={styles.section}>
          ...
          >
            <View style={styles.actionButtonContent}>
              ...
              <View style={styles.actionTextContainer}>
                ...
                <Text style={styles.actionButtonSubtitle}>Create a new blood donation request</Text>
              </View>
          ...
          >
            <View style={styles.actionButtonContent}>
              <View style={[styles.actionIconCircle, { backgroundColor: palette.primaryRed }]}>
                <Ionicons name="list" size={24} color={palette.white} />
              </View>
              <View style={styles.actionTextContainer}>
                <Text style={[styles.actionButtonTitle, { color: palette.darkText }]}>My Requests</Text>
                <Text style={[styles.actionButtonSubtitle, { color: palette.lightText }]}>View and manage your requests</Text>
              </View>
              <Ionicons name="chevron-forward" size={24} color={palette.lightText} />
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            ...
            <TouchableOpacity onPress={() => router.push('/hospital-my-requests')}>
          ...
          {recentRequests.length === 0 ? (
            <View style={styles.emptyContainer}>
              <Ionicons name="document-outline" size={48} color={palette.lightText} />
            ...
            recentRequests.map((request) => (
              <TouchableOpacity
                ...
                onPress={() => router.push(`/hospital-request-details?id=${request.id}`)}
              >
                <View style={styles.requestHeader}>
                  ...
                  <View style={[styles.urgencyBadge, { backgroundColor: getUrgencyColor(request.urgency) + '15' }]}>
                    <Ionicons name={getUrgencyIcon(request.urgency)} size={14} color={getUrgencyColor(request.urgency)} />
                ...
                <View style={styles.requestFooter}>
                  <View style={styles.donorsInfo}>
                    ...
                    <Text style={styles.donorsText}>
                      {request.acceptedDonors?.length || 0} donor{(request.acceptedDonors?.length || 0) !== 1 ? 's' : ''} accepted
                    </Text>
                  </View>
                  <View style={[styles.statusBadge, { 
                    backgroundColor: request.status === 'active' ? palette.success + '15' : palette.lightText + '15' 
                  }]}>
                    <Text style={[styles.statusText, { 
                      color: request.status === 'active' ? palette.success : palette.lightText 
                    }]}>
                      {request.status}
                    </Text>
                  </View>
